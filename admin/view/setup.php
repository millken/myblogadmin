...
<div id="container">
    ...
    <div id="m_admin">
        <form method="post">
            ...
            <table class="form-table">
                ...
                <td><input type="text" size="45" value="Micolog"  id="title" name="title"/>
                </td>
                ...
                <tr valign="top">
                <th scope="row">子标题</th>
                <td><input type="text" size="45" value="This is a micro blog." style="width: 95%;" id="subtitle" name="subtitle" />
                <br/>
                关于这个博客的简单介绍</td>
                </tr>
                ...
                <tr valign="top">
                <th scope="row">公告</th>
                <td><textarea id="blognotice" style="width:95%" cols="45" rows="2" name="blognotice"></textarea>
               </td>
                 </tr>
                  <tr valign="top">
                <th scope="row">域名:</th>
                <td><input type="text" size="45" value="localhost:8080"  id="domain" name="domain" />
               </td>
                </tr>
                </tr>
                  <tr valign="top">
                ...
                <td><input type="text" size="45" value="http://localhost:8080"  id="baseurl" name="baseurl" />
               </td>
                </tr>

                 <tr valign="top">
                <th scope="row">RSS/Atom Feed地址:</th>
                <td><input type="text" size="45" value="http://localhost:8080/feed"  id="feedurl" name="feedurl" />

               </td>
                </tr>
                 <tr valign="top">
                <th scope="row">时间差调整(单位:小时):</th>
                <td><input type="text" size="45" value="8.0"  id="timedelta" name="timedelta" />
               </td>
                </tr>
            ...
            <tr valign="top">
                ...
                <td><input type="text" size="8" value="10"  id="posts_per_page" name="posts_per_page" />
               </td>
   ...
   <tr valign="top">
                ...
                <td><input type="text" size="8" value="20"  id="comments_per_page" name="comments_per_page" />
               </td>
               </tr>
                ...
                <td><input type="checkbox" size="45"  checked="checked"   id="enable_memcache" name="comment_notify_mail" />
               </td>
                </tr>
    <tr valign="top">
  ...
  <tr valign="top">
            ...
            <table class="form-table">
               <tr valign="top">
                <th scope="row">用户名:</th>
                <td><input type="text" size="45" value="admin"  id="rpcuser" name="rpcuser" />
               </td>
                </tr>

                <tr valign="top">
                <th scope="row">密码:</th>
                <td><input type="password" size="45" value=""  id="rpcpassowrd" name="rpcpassword" />
               </td>
                </tr>
            </table>
